...
export type ProjectsInlineFiltersProps = {
  status: StatusFilter;
  setStatus: (s: StatusFilter) => void;
  due: ProjectDueFilter;
  setDue: (d: ProjectDueFilter) => void;
  priority: PriorityFilter;
  setPriority: (p: PriorityFilter) => void;
  className?: string; // <-- NEW: lets you add right-margin in the header
};
...
export function ProjectsInlineFilters({
  status,
  setStatus,
  due,
  setDue,
  ...
  return (
    <div className={cn("relative", className)}>
      {/* Summary row: Filters button FIRST, then chips */}
      <div className="flex flex-wrap items-center gap-2">
        ...
        {/* subtle divider between button and chips */}
        <span
          aria-hidden
